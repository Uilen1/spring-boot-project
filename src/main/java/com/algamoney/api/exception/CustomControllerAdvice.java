...
public class CustomControllerAdvice extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({ PessoaNotFoundException.class, CategoriaNotFoundException.class })
	public ResponseEntity<Object> handlePessoaNotFound(RuntimeException ex, WebRequest request) {
